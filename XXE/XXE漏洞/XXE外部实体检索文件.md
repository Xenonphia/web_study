...
![](assets/XXE外部实体检索文件/file-20260110224134305.png)

![](assets/XXE外部实体检索文件/file-20260110224134302.png)

首先可以判断出来的是，登录失败会显示username+登陆失败的提示
查看源代码

![](assets/XXE外部实体检索文件/file-20260110224134303.png)
...
![](assets/XXE外部实体检索文件/file-20260110224134301.png)
