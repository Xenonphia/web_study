...
如果是protected受保护类型，则是会有%00*%00多出，实际字符串长度多了3

# 成员属性调用对象
![](assets/序列化/file-20260110134823068.png)

```php
O:5:"test2":1:{s:3:"ben";O:4:"test":1:{s:3:"pub";s:6:"benben";}}
```

可以看到class test2的一个属性ben的参数是class test的一个实例化对象
*test2的ben由construct方法给ben属性赋值了test实例化对象*

![](assets/序列化/file-20260110135413164.png)

因此可以使用这种方法去获取类的属性
```php
O:2:"t2":1:{s:3:"sky";O:2:"t1":1:{s:3:"guc";s:4:"miss";}}

O:2:"t1":1:{s:3:"guc";s:4:"miss";}
```