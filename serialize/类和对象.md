...
构建一个继承Guc的子类
```php
class InheritanceGuc extends Guc

{

    // 继承Guc类，可以添加新的属性或方法，子类可以访问父类的protected属性
...
在构建一个新的对象并且调用函数
```php
$me2 = new InheritanceGuc();//实例化子类
$me2 -> showSex();//此时是protected属性，可以访问子类
```


## 包括方法也一样，默认都是public类型